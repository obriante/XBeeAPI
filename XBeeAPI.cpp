...
void
sendZBTxRequest(XBeeAddress64 remoteAddress64, uint8_t * payload, int length)
{
...
void
sendAtCommandRequest(uint8_t * cmd)
{
...
void
sendAtCommandRequest(uint8_t * cmd, uint8_t * value, int vlength)
{
...
void
sendRemoteAtCommandRequest(uint16_t remoteAddress16, uint8_t * cmd, uint8_t * value, int vlength)
{
...
void
sendRemoteAtCommandRequest(uint16_t remoteAddress16, uint8_t * cmd)
{
 ...
 */
boolean
__recvAll(int timeout, int api_id)
{
...
boolean
recvZBTxStatusResponse(int timeout)
{
...
boolean
recvModemStatusResponse(int timeout)
{
...
boolean
recvRemoteAtCommandResponse(int timeout)
{
...
boolean
recvZBRxIoSampleResponse(int timeout)
{
...
boolean
recvAtCommandResponse(int timeout)
{
